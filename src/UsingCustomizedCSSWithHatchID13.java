...
public class UsingCustomizedCSSWithHatchID13 {
	...
	public static void main(String[] args) {
	  ...
	  // Customized CSS with HatchID  TagName#id 
 	  driver.findElement(By.cssSelector("input#email")).sendKeys("97aio@yahoo.co.uk"); //Find email field via customized CSS hatchID
